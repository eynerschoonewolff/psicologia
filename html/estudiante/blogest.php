                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-8 col-md-6 col-sm-12">
                            <div class="card-body">
                                ...
                                <p class="card-text">Para prevenir el maltrato infantil en los niveles sociales comunitarios, es importante la introducción de reformas...</p>
                                <a href="blogMaltrato.php" class="btn btn-outline-primary">leer mas</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-8 col-md-6 col-sm-12">
                            <div class="card-body">
                                ...
                                <p class="card-text">El acoso escolar es el acto de agresión u hostigamiento, realizado por estudiantes que atenten en contra de otro estudiante...</p>
                                <a href="blogMaltratoPsicologico.php" class="btn btn-outline-primary">leer mas</a>
                            </div>
                        </div>
                    </div>
                </div>

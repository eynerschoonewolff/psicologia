...
<body>
  ...
  <div class="container shadow-lg my-5">
    ...
    <p class="fs-1 text-center mt-5"><i class="bi bi-calendar2-week"> </i>Gestión de solicitudes</p>
              ...
              <table class="table table-bordered table table-hover">
                ...
                <tbody id="tablacontenidoContacto">
                  ...
                  ?>
                      ...
                      <tr>
                        <td>
                          <?php echo $mostrar['nombres']." ".$mostrar['apellidos'] ?><a
                            class="text-info text-decoration-none" href="#" data-bs-toggle="modal"
